...
//원래는 다른 파일에 작성해야 함
// import useCounter from "./useCounter"; // 다른 파일에 커스텀훅 임포트

export function Counter() {
  const { count, increase, decrease, reset } = useCounter(0); // 커스텀 훅의 리턴값이 들어감
...
// export default Counter; // 이 경우, function Counter() 앞에 export 안 붙임
