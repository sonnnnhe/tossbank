...
export function Sum(props) {
  // 정수가 아니고 숫자라서 parseInt로 하는게 더 나은 거 같다고 하셨음..
  //parseInt, parseFloat, Number(), Math.floor()
  let n1 = Number(props.num1);
  let n2 = Number(props.num2);
  let rst = n1 + n2;
  return <h1>{rst}</h1>;
}
